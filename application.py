...
class Main(object):
    ...
    def __init__(self):
        ...
        self.lb1 = Label(
            self.root,
            text="Welcome To Self-Adapting Interactive Segmentation Tool",
            width=100,
            height=2,
            fg="black",
            font=("times", 20, " bold"),
    ...
    def choose(self):
        ...
        self.ifile = filedialog.askopenfile(
        ...
        self.original = self.img.resize((450, 450), Image.Resampling.LANCZOS)
    ...
    def predict_image(self, p_img):
        ...
        p_img = cv2.resize(p_img, (128, 128))  # Add this line
        p_img = (
            p_img / 255.0
        )  # Optional: normalize if model was trained with normalized data

        pred = model.predict(p_img.reshape(1, 128, 128, 3))
        pred[pred > 0.5] = 1
        pred[pred < 0.6] = 0

        pred = pred[:, :, :, 0].reshape((128, 128))
        pred = np.uint8(pred)
        output = pred
        ...
        # model = load_model(
        #     "D:/Users/Krishna Jajoo/Downloads/new_with_0_wbc_segmentation_model.h5",
        #     compile=False,
        # )
        # model1 = load_model(
        #     "D:/Users/Krishna Jajoo/Downloads/new_with_255_wbc_segmentation_model.h5",
        #     compile=False,
        # )
        # pred = model.predict(p_img.reshape(1, 128, 128, 3))
        ...
        # model=load_model(r'C:\Users\krish\OneDrive\Desktop\personal_growth\Skin-Lesion\application\outputs\unet_segmentation_model.h5', compile=False)
