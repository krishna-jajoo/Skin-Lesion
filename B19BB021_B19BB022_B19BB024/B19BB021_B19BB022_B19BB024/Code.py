# -*- coding: utf-8 -*-
"""B19BB021_B19BB022_B19BB024.ipynb
...
X_train,X_test,y_train,y_test = train_test_split(image_files,mask_files,test_size=0.01)
...
def Generator(X_list,batch_size):
    while 1:
        ...
        for i in range(batch_size):
            ...
            image,mask = create(X_list[i-1],'/content/drive/MyDrive/dermoscopic dataset/dataset/')
            all_i.append(image)
...
def predict_image(p_img):
  p_img = cv2.resize(p_img,(120,120))
  p_img = cv2.resize(p_img,(128,128))
  model=torch.load('/content/drive/MyDrive/dermoscopic dataset/dermo_segmentation_dl_model.h5', compile=False)
